...
const HorizontalScrollCard = ({data =[], heading, trending, media_type}) => {
    ...
    const handleNext = () =>{
        containerRef.current.scrollLeft +=255
    }
  ...
  return (
    <div className='container mx-auto px-3 my-10'>
          ...
          <div className='relative'>
                <div ref={containerRef} className='grid grid-cols-[repeat(auto-fit,230px)] grid-flow-col gap-6 overflow-hidden relative overflow-x-scroll z-10 scroll-smooth transition-all scrollbar-none'>
                    {
                        data.map((data,index)=>{
                        return (
